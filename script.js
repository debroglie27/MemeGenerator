// Clears the content from all containers
function clearAll() {
...
function showMeme() {
  ...
  memeImgElement.setAttribute("src", randomMemeUrl);
  memeContainer.appendChild(memeImgElement);
}

// Shows a JOKE on the screen
function showJoke() {
  clearAll();
  // Value is a string representing the joke
  const randomJokeText = getRandomData("jokes");
  const jokeContainer = document.querySelector(".joke-content");
  const jokeParagraphElement = document.createElement("p");

  jokeParagraphElement.textContent = randomJokeText;
  jokeContainer.appendChild(jokeParagraphElement);
}

// Shows a QUOTE on the screen
function showQuote() {
  clearAll();
  // Value should be in format: { quote: '', author: '' }
  const randomQuote = getRandomData("quotes");
  const quoteContainer = document.querySelector(".quote-content");
  const quoteParagraphElement = document.createElement("p");
  const authorParagraphElement = document.createElement("p");

  quoteParagraphElement.textContent = randomQuote.quote;
  authorParagraphElement.textContent = "- " + randomQuote.author;
  quoteContainer.appendChild(quoteParagraphElement);
  quoteContainer.appendChild(authorParagraphElement);
}

// Shows a RIDDLE on the screen
function showRiddle() {
  clearAll();
  ...
  riddleContainer.appendChild(questionParagraphElement);
  riddleContainer.appendChild(answerParagraphElement);
}
